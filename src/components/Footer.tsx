    ...
    <footer className="w-full border-t border-neutral-200/80 dark:border-neutral-800 bg-white dark:bg-[#121214] mt-auto transition-colors no-print">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mt-6 pt-6 border-t border-neutral-100 dark:border-neutral-800/60 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-[11px] text-neutral-400 dark:text-neutral-500">
          <p>Created by Arpan Goswami • DNS by <a href="https://www.dnsexit.com" target="_blank" rel="noopener noreferrer" className="hover:underline text-neutral-500 dark:text-neutral-400">DNS Exit</a></p>
